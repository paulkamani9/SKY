...
export const strings = {
  en: {
    ...
    language: "Language",
    fruits: "Today's fruit selection",
  ...
  fr: {
    ...
    language: "Langue",
    fruits: "Notre sélection de fruits du jour",
    empty:
  ...
  it: {
    ...
    language: "Lingua",
    fruits: "La nostra selezione di frutta del giorno",
  ...
  de: {
    ...
    language: "Sprache",
    fruits: "Unsere Früchte des Tages",
    empty:
  ...
  ru: {
    ...
    language: "Язык",
    fruits: "Фрукты сегодняшнего дня",
